...
int main(int argc, char *argv[])
{
    ...
    auto mainWinBuilder = Gtk::Builder::create_from_file((string)getenv("HOME")+"/.picket/MainWindow.glade");
    auto colorPickerWinBuilder = Gtk::Builder::create_from_file((string)getenv("HOME")+"/.picket/ColorPickerWindow.glade");
    auto settingWindowBuilder = Gtk::Builder::create_from_file((string)getenv("HOME")+"/.picket/SettingsWindow.glade");
